...
<script>
    ...
    $(document.body).infinite().on("infinite", function () {
        ...
        num += 10;
        $.ajax({
            url: '/index.php/home/article/article_list',
            type: 'POST',
            data: {
                type: 'last',
                num: num
            ...
            success: function (data) {
                ...
                data.forEach(element => {
                    $('.weui-panel__bd').eq(0).append('<a href="articleContent.html?id=' + element.id + '' +
                        '" class="weui-media-box weui-media-box_appmsg"><div class="weui-media-box__hd">' +
                        '<img class="weui-media-box__thumb" src="http://mensan.xyz/' + element.list_thumb + '" width="60" height="60"></div><div class' +
    ...
    $(document.body).infinite().on("infinite", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                data.forEach(element => {
                    $('.weui-panel__bd').eq(1).append('<a href="articleContent.html?id=' + element.id + '' +
                        '" class="weui-media-box weui-media-box_appmsg"><div class="weui-media-box__hd">' +
                        '<img class="weui-media-box__thumb" src="http://mensan.xyz/' + element.list_thumb + '"  width="60" height="60"></div><div class' +
                        '="weui-media-box__bd"><h4 class="weui-media-box__title">' + element.title + '</h4><p ' +
                        'class="weui-media-box__desc">阅读量：' + element.reading + '</p></div></a>');
