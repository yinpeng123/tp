...
var MainManager = function () {
    ...
    function i(a) {
        (X = !X) ? ($("#bt_backtrack a").text("背景音乐: 开启"), aidn.util.setCookie("bt", "on", 2592e3)) : ($("#bt_backtrack a").text("背景音乐: 关闭"), aidn.util.setCookie("bt", "off", 2592e3)),
        a && a.preventDefault()
    }
    function o() {
    ...
    function () {
            ...
            this.init = function (t, o) {
                ...
                (n = new WebAudioManager).load("https://record.mensan.xyz/Public/index/data/track/track.json", r, a, e)
            },
    ...
    function () {
            ...
            this.init = function (n, t) {
					...
					console.log(r,a,e);
                    (i = new WebAudioManager).load("https://record.mensan.xyz/Public/index/data/main/main.json", r, a, e)
                },
    ...
    function () {
            ...
            function t(e) {
                ...
                if (r(n), e.originalEvent && e.originalEvent.touches) for (var t = e.originalEvent.touches.length, i = 1; i < t; i++) n = e.originalEvent.touches[i],
                n = a(n.pageX, n.pageY),
                r(n, 1)
            }
            function i(e) {
    ...
    i(),
    aidn.util.webaudio ? ($("#ng").css("display", "none"), $(".ok").css("display", "block"), m && $("#scene_main .attention").html("轻触 &amp; 滑动!"), u || $("#scene_top .attention").text("* 开始尽情释放你的压力吧！！")) : ($("#ng").css("display", "block"), $(".ok").css("display", "none"), u || $("#ng .atten").html("抱歉，</br>你的浏览器不支此页面")),
