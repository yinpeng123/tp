        ...
        <div class="tplay-body-div">
            <div class="layui-tab">
                <ul class="layui-tab-title">
                    <li  class="layui-this"><a href="/index.php/Admin/Topic/index" class="a_menu">题目管理</a></li>
                    <li><a href="/index.php/Admin/Topic/publish" class="a_menu">新增题目</a></li>
                </ul>
            </div>
            ...
            <table class="layui-table" lay-size="sm">
                ...
                <tbody>
                <?php if(is_array($topic)): $i = 0; $__LIST__ = $topic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($vo["id"]); ?></td>
                        <td><?php echo ($vo["topic_name"]); ?></td>
                        <td><?php echo ($vo["topic_time"]); ?></td>
                        <td>
                            <a href="<?php echo U('admin/topicContent/index');?>?id=<?php echo ($vo["id"]); ?>" style="color: #ffffff" class="layui-btn">列表</a>
                            <a href="<?php echo U('admin/topic/publish');?>?id=<?php echo ($vo["id"]); ?>" style="color: #ffffff" class="layui-btn">编辑</a>
            ...
            <script type="text/javascript">
                ...
                $('.delete').click(function(){
                    ...
                    layer.confirm('确定要删除?', function(index) {
                        $.ajax({
                            url:"<?php echo U('admin/topic/del');?>",
                            type:'POST',
                            data:{id:id},
