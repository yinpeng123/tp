				...
				function readFile() {
					...
					for(var i = 0; i < iLen; i++) {
						...
						reader.onload = function(e) {
							...
							result = '<div class="showdiv"><img class="left none" src="../images/Arrow_left.svg" /><img class="center" src="../images/delete.svg" /><img class="right none" src="../images/Arrow_right.svg" /></div><img id="srcimgid' + currentReViewImgIndex + '" class="showimg" src="' + this.result + '" />';
